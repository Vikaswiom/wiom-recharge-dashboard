...
c1 = json.dumps({"data":[{"type":"histogram","x":t2p_hist_h,"nbinsx":30,"marker":{"color":"#4ECDC4","line":{"color":"#0a0a0a","width":1}}}],
    "layout":{"title":{"text":"Install to First Paid (Hours)","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"Hours","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":420}})
...
c2 = json.dumps({"data":[{"type":"bar","x":cb_l,"y":cb_v,"marker":{"color":["#27AE60","#4ECDC4","#FFEAA7","#F39C12","#E74C3C"]},
    ...
    "layout":{"title":{"text":"Conversion Time Buckets (from Install)","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"tickfont":{"color":"#ccc"},"gridcolor":"#1a1a1a"},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":420}})
...
c3 = json.dumps({"data":[{"type":"pie","labels":["Before Trial Expiry","After Trial Expiry","Never Converted"],"values":[n_before_trial,n_after_trial,n_never_converted],
    "marker":{"colors":["#27AE60","#4ECDC4","#E74C3C"],"line":{"color":"#0a0a0a","width":2}},"textinfo":"label+value+percent","textfont":{"size":11,"color":"white"},"hole":0.4}],
    "layout":{"title":{"text":"Conversion Timing vs Trial Expiry","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},"height":420}})
...
c4 = json.dumps({"data":[{"type":"bar","x":fpd_labels,"y":fpd_values,
    "marker":{"color":"#4ECDC4","line":{"color":"#0a0a0a","width":1}},
    "text":[f"{v} ({p}%)" for v,p in zip(fpd_values,_fpd_pcts)],"textposition":"outside","textfont":{"color":"white","size":11}}],
    "layout":{"title":{"text":"First Paid Plan Duration (All Users)","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"Plan Duration","tickfont":{"color":"#ccc"},"categoryorder":"array","categoryarray":fpd_labels},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":420}})
...
c5 = json.dumps({"data":c5_traces,
    "layout":{"title":{"text":"Month-Wise First Plan Distribution","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "barmode":"group","xaxis":{"tickfont":{"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},
...
c6 = json.dumps({"data":[
    ...
    "layout":{"title":{"text":"Paid Recharge Retention (Eligible Only)","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"Paid Recharge #","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"},"dtick":1},
    "yaxis":{"title":"Retention %","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"},"range":[0,105]},
...
c7 = json.dumps({"data":[
    ...
    "layout":{"title":{"text":"User Status at Each Paid Recharge Step","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "barmode":"stack","height":460,"xaxis":{"tickfont":{"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"legend":{"font":{"color":"#ccc"}}}})
...
c8 = json.dumps({"data":[
    ...
    "paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"Plan Duration","tickfont":{"color":"#ccc"}},"yaxis":{"title":"Hours","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},
...
c9 = json.dumps({"data":_gap_hist_data,
    ...
    "paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"Hours","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"yaxis":{"title":"Count","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},
...
c10 = json.dumps({"data":[{"type":"bar","x":_pg_labels,"y":_pg_cnt,"marker":{"color":["#E74C3C","#9B59B6","#F39C12","#FFEAA7","#4ECDC4"]},
    ...
    "paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"Plan Duration","tickfont":{"color":"#ccc"}},"yaxis":{"title":"Gap Count","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":400}})

# 11. Segment pie
sn = list(seg_profiles.keys()); sc = [seg_profiles[s]['count'] for s in sn]
c11 = json.dumps({"data":[{"type":"pie","labels":sn,"values":sc,"marker":{"colors":["#27AE60","#FFEAA7","#E74C3C","#3498DB","#FF6B6B","#BB8FCE"][:len(sn)],"line":{"color":"#0a0a0a","width":2}},
    "textinfo":"label+value+percent","textfont":{"size":10,"color":"white"},"hole":0.4}],
    "layout":{"title":{"text":"User Segments","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},"height":420,"legend":{"font":{"color":"#ccc","size":9}}}})
...
c12 = json.dumps({"data":[
    ...
    "layout":{"title":{"text":"Segment Comparison","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "barmode":"group","height":460,"xaxis":{"tickfont":{"size":8,"color":"#ccc"}},"yaxis":{"title":"Days","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"legend":{"font":{"color":"#ccc"}}}})
...
c14 = json.dumps({"data":[
    ...
    "layout":{"title":{"text":"Daily Installs & Active Paid Users","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"tickangle":-45,"tickfont":{"size":9,"color":"#ccc"},"gridcolor":"#1a1a1a"},
    "yaxis":{"title":"Install/Cum","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},
...
c15 = json.dumps({"data":[
    ...
    "layout":{"title":{"text":"Daily Plan Expirations & Re-Recharges","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "barmode":"group","xaxis":{"tickangle":-45,"tickfont":{"size":9,"color":"#ccc"}},"yaxis":{"title":"Count","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"legend":{"font":{"color":"#ccc"}},"height":480,"margin":{"b":100}}})

# 16. Sankey
c16 = json.dumps({"data":[{"type":"sankey","node":{"label":sankey_labels,"color":sankey_node_colors,"pad":20,"thickness":20,"line":{"color":"#0a0a0a","width":1}},
    "link":{"source":sankey_src,"target":sankey_tgt,"value":sankey_val,"color":sankey_link_clr}}],
    "layout":{"title":{"text":"Plan Duration Flow (Paid Recharges)","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white","size":10},"height":550,"margin":{"l":20,"r":20}}})
...
c17 = json.dumps({"data":[{"type":"heatmap","z":trans_z,"x":all_plan_types_with_nr,"y":all_plan_types,
    "colorscale":[[0,"#0a0a0a"],[0.5,"#E91E63"],[1,"#E74C3C"]],"text":trans_z,"texttemplate":"%{text}","textfont":{"size":12,"color":"white"}}],
    "layout":{"title":{"text":"Plan Transition Matrix (incl. No Recharge)","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
...
c18 = json.dumps({"data":[{"type":"bar","name":pt,"x":dist_x,"y":[rech_plan_dist[n].get(pt,0) for n in range(1,max_dist+1)],
    ...
    "layout":{"title":{"text":"Plan Type by Paid Recharge #","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "barmode":"stack","height":420,"xaxis":{"tickfont":{"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"legend":{"font":{"color":"#ccc"}}}})
...
c19 = json.dumps({"data":[{"type":"funnel","y":funnel_labels,"x":funnel_values,"textinfo":"value+percent initial","textfont":{"color":"white","size":12},
    ...
    "layout":{"title":{"text":f"Trial Funnel","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},"height":420,"margin":{"l":220}}})
...
c20 = json.dumps({"data":[{"type":"bar","x":ct_l,"y":ct_v,"marker":{"color":["#27AE60","#4ECDC4","#FFEAA7","#F39C12","#E74C3C"]},
    ...
    "layout":{"title":{"text":"Post-Trial Conversion Timing","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"tickfont":{"size":9,"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":420}})
...
c21 = json.dumps({"data":[{"type":"scatter","x":cum_conv_x,"y":cum_conv_y,"mode":"lines+markers","fill":"tozeroy",
    ...
    "layout":{"title":{"text":"Cumulative Conversion After Trial Expiry","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"Days After Expiry","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"},"dtick":1},"yaxis":{"title":"% Converted","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"},"range":[0,105]},"height":420}})
...
c22 = json.dumps({"data":pt_traces,"layout":{"title":{"text":"Plan by Conversion Timing","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "barmode":"stack","height":420,"xaxis":{"tickfont":{"size":9,"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"legend":{"font":{"color":"#ccc"}}}})
...
c23 = json.dumps({"data":[{"type":"bar","x":im_labels,"y":im_values,"marker":{"color":"#BB8FCE"},"text":im_values,"textposition":"outside","textfont":{"color":"white","size":11}}],
    "layout":{"title":{"text":"Install Month","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"type":"category","tickfont":{"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":400}})
...
c24 = json.dumps({"data":[{"type":"bar","x":rbla,"y":rby,"marker":{"color":"#FF6B6B"},"text":rby,"textposition":"outside","textfont":{"color":"white","size":9}}],
    "layout":{"title":{"text":"R-Day Distribution (Non-Converted)","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"R-Day","tickfont":{"size":9,"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":460}})
...
c25 = json.dumps({"data":[{"type":"scatter","x":[f"R{d}" for d in rday_cum_x],"y":rday_cum_pct,"mode":"lines+markers","fill":"tozeroy",
    ...
    "layout":{"title":{"text":"Cumulative Non-Converted by R-Day","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"R-Day","tickfont":{"size":9,"color":"#ccc"}},"yaxis":{"title":"% Still Not Converted","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"},"range":[0,105]},"height":420}})
...
c26 = json.dumps({"data":[{"type":"bar","x":rbl2,"y":rbv2,"marker":{"color":["#4ECDC4","#27AE60","#F39C12","#E74C3C"]},
    ...
    "layout":{"title":{"text":"R-Day Risk Buckets","font":{"size":18,"color":"white"}},"paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"tickangle":-15,"tickfont":{"size":9,"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":420,"margin":{"b":80}}})
...
c27 = json.dumps({"data":_freq_traces,
    ...
    "paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"title":"Plan Type","tickfont":{"color":"#ccc"}},"yaxis":{"title":"Count","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},
    "height":460,"legend":{"font":{"color":"#ccc"}}}})
...
c28 = json.dumps({"data":[{"type":"bar","x":_cd_labels,"y":_cd_vals,
    ...
    "paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},
    "xaxis":{"type":"category","tickfont":{"color":"#ccc"}},"yaxis":{"title":"Users","gridcolor":"#1a1a1a","tickfont":{"color":"#ccc"}},"height":420}})
...
c29 = json.dumps({"data":[{"type":"pie","labels":_cbp_labels,"values":_cbp_vals,
    "marker":{"colors":["#E74C3C","#9B59B6","#F39C12","#FFEAA7","#4ECDC4"],"line":{"color":"#0a0a0a","width":2}},
    ...
    "paper_bgcolor":"#0a0a0a","plot_bgcolor":"#0a0a0a","font":{"color":"white"},"height":420}})
...
.kpi{{background:#0a0a0a;border:1px solid #222;border-radius:12px;padding:16px;text-align:center;transition:transform .2s}}
.kpi:hover{{transform:translateY(-3px);box-shadow:0 6px 24px rgba(233,30,99,.12)}}
.kpi .v{{font-size:26px;font-weight:800}}.kpi .l{{font-size:10px;color:#777;text-transform:uppercase;letter-spacing:1px}}
.tabs{{display:flex;padding:0 36px;border-bottom:1px solid #222;overflow-x:auto;gap:0}}
...
.tab:hover{{color:#aaa}}.tab.active{{color:#E91E63;border-bottom-color:#E91E63}}
.tc{{display:none;padding:18px 36px}}.tc.active{{display:block}}
.box{{background:#0a0a0a;border:1px solid #1a1a1a;border-radius:12px;padding:14px;margin-bottom:16px}}
.ins{{background:#0d0d0d;border-left:4px solid #E91E63;border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-size:13px;line-height:1.7}}
.ins b{{color:#E91E63}}.ins .r{{color:#FF6B6B}}.ins .g{{color:#2ECC71}}.ins .y{{color:#F1C40F}}
table{{width:100%;border-collapse:collapse;margin:8px 0;font-size:12px}}
th{{background:#0d0d0d;color:#E91E63;padding:9px 10px;text-align:left;border-bottom:2px solid #222;font-size:10px;text-transform:uppercase;letter-spacing:.5px}}
td{{padding:7px 10px;border-bottom:1px solid #1a1a1a}}tr:hover{{background:#111}}
...
.badge-r{{background:rgba(231,76,60,.15);color:#E74C3C}}.badge-g{{background:rgba(39,174,96,.15);color:#27AE60}}
.badge-y{{background:rgba(241,196,15,.15);color:#F1C40F}}.badge-b{{background:rgba(52,152,219,.15);color:#3498DB}}
.hyp{{margin-bottom:10px;padding:12px;background:#111;border-radius:8px;border-left:3px solid;font-size:13px;line-height:1.6}}
...
function applyDateFilter(){{
  ...
  Plotly.react("c-c2",[{{type:"bar",x:bktOrder,y:bV,marker:{{color:bktColors}},text:bT,textposition:"outside",textfont:{{color:"white",size:11}}}}],
    {{title:{{text:"Conversion Time Buckets (Filtered)",font:{{size:18,color:"white"}}}},paper_bgcolor:"#0a0a0a",plot_bgcolor:"#0a0a0a",font:{{color:"white"}},
    xaxis:{{tickfont:{{color:"#ccc"}},gridcolor:"#1a1a1a"}},yaxis:{{title:"Users",gridcolor:"#1a1a1a",tickfont:{{color:"#ccc"}}}},height:420}},cfg);
  ...
  Plotly.react("c-c4",[{{type:"bar",x:fpL,y:fpV,marker:{{color:"#4ECDC4",line:{{color:"#0f0f23",width:1}}}},text:fpT,textposition:"outside",textfont:{{color:"white",size:11}}}}],
    {{title:{{text:"First Paid Plan Duration (Filtered)",font:{{size:18,color:"white"}}}},paper_bgcolor:"#0a0a0a",plot_bgcolor:"#0a0a0a",font:{{color:"white"}},
    xaxis:{{title:"Plan Duration",tickfont:{{color:"#ccc"}},categoryorder:"array",categoryarray:fpL}},yaxis:{{title:"Users",gridcolor:"#1a1a1a",tickfont:{{color:"#ccc"}}}},height:420}},cfg);
  ...
  Plotly.react("c-c5",c5traces,
    {{title:{{text:"Month-Wise First Plan (Filtered)",font:{{size:18,color:"white"}}}},barmode:"group",paper_bgcolor:"#0a0a0a",plot_bgcolor:"#0a0a0a",font:{{color:"white"}},
    xaxis:{{tickfont:{{color:"#ccc"}}}},yaxis:{{title:"Users",gridcolor:"#1a1a1a",tickfont:{{color:"#ccc"}}}},height:450,legend:{{font:{{color:"#ccc"}}}}}},cfg);
  ...
  Plotly.react("c-c28",[{{type:"bar",x:churnRechOrder,y:cdV,marker:{{color:["#E74C3C","#F39C12","#FFEAA7","#27AE60"]}},text:cdV.map(String),textposition:"outside",textfont:{{color:"white",size:12}}}}],
    {{title:{{text:"Churned Users by Recharge Count (Filtered)",font:{{size:16,color:"white"}}}},paper_bgcolor:"#0a0a0a",plot_bgcolor:"#0a0a0a",font:{{color:"white"}},
    xaxis:{{tickfont:{{color:"#ccc"}}}},yaxis:{{title:"Users",gridcolor:"#1a1a1a",tickfont:{{color:"#ccc"}}}},height:400}},cfg);
  ...
  Plotly.react("c-c26",[{{type:"bar",x:rOrder,y:rV,marker:{{color:["#4ECDC4","#27AE60","#F39C12","#E74C3C"]}},text:rV.map(String),textposition:"outside",textfont:{{color:"white",size:12}}}}],
    {{title:{{text:"R-Day Risk Buckets (Filtered)",font:{{size:16,color:"white"}}}},paper_bgcolor:"#0a0a0a",plot_bgcolor:"#0a0a0a",font:{{color:"white"}},
    xaxis:{{tickfont:{{color:"#ccc"}}}},yaxis:{{title:"Users",gridcolor:"#1a1a1a",tickfont:{{color:"#ccc"}}}},height:400}},cfg);
